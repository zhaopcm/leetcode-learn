...
public:
    ...
    int turn_right(vector<vector<int>>& dungeon, int i, int j){
        int sum = 0;
        sum = dungeon[i][j] + dungeon[i][j+1];
        return sum;
    }

    int turn_down(vector<vector<int>>& dungeon, int i, int j){
        int sum = 0;
        sum = dungeon[i][j] + dungeon[i+1][j];
        return sum;
    }
};
